...
class SelectIconController:UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        let iconSetTwo = IconSet(title: "Occupation", icons:[#imageLiteral(resourceName: "welder"),#imageLiteral(resourceName: "gentleman"),#imageLiteral(resourceName: "builder-1"),#imageLiteral(resourceName: "swat"),#imageLiteral(resourceName: "soldier"),#imageLiteral(resourceName: "showman"),#imageLiteral(resourceName: "diver"),#imageLiteral(resourceName: "scientist"),#imageLiteral(resourceName: "boy-4"),#imageLiteral(resourceName: "dj")])
