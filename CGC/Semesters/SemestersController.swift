...
class SemestersController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        semesters = [
            Semester(icon: #imageLiteral(resourceName: "alien-1"), title: "Fall 19", classes: [SemesterClass(icon: #imageLiteral(resourceName: "robot"), title: "class boi", grade: "A-", creditHours: 3)]),
            Semester(icon: #imageLiteral(resourceName: "alien-1"), title: "my semester", classes: []),
            Semester(icon: #imageLiteral(resourceName: "astronaut"), title: "Spring 18", classes: [SemesterClass(icon: #imageLiteral(resourceName: "robot"), title: "class swag", grade: "A-", creditHours: 6),SemesterClass(icon: #imageLiteral(resourceName: "robot"), title: "class title", grade: "A", creditHours: 3)]),
        ]
